...
/// الحلقات — all circles the current user belongs to, shown as rich «وِصَال»
/// cards with per-circle student count and memorization average.
        ...
        builder: (context, snap) {
          ...
          return ListView(
            ...
            children: [
              ...
              for (final s in stats) _CircleCard(stat: s, user: user),
